    ...
    const products = [
        {
            ...
            name: '클래식 언퍼게터블 스웨이드\n클로그',
            images: [
                { src: '/images/Sub_Women_Images/1_클래식_언퍼게터블_스웨이드_클로그_1.jpg', alt: '클래식 언퍼게터블 스웨이드 클로그 이미지 1' },
                { src: '/images/Sub_Women_Images/1_클래식_언퍼게터블_스웨이드_클로그_2.jpg', alt: '클래식 언퍼게터블 스웨이드 클로그 이미지 2' }
            ],
    ...
    return (
        <main>
            <div className="section__wrap">
                <LeftNavigation category="여성" subcategory="털안감 라인드 클로그" sizes={sizes} filters={filters} />
