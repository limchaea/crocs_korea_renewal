...
const CrocsProductDetail = () => {
    ...
    const normalizeCate = (cateString) => {
        ...
        if (lower.includes('women') || lower.includes('여성') || lower.includes('여')) return 'women';
                            ...
                            <div className="content-inner">
                                <div className="jibbitz-grid">
                                    {randomJibbitz.map((jibbitz) => {
                                        const hasDiscount = jibbitz.discountPrice && jibbitz.discountPrice !== '';
                                        const displayPrice = hasDiscount ? jibbitz.discountPrice : jibbitz.price;
                        ...
                        <div className={`tab-content ${openNotes ? 'active' : ''}`}>
                            <div className="content-inner">
                                <div className="desc-section">
                                    ...
                                    <ul className="desc-list">
                                        <li>에스컬레이터나 무빙워크에서 사고방지를 위한 안내 안전선 안에 위치하시고, 접촉면 어디에도 닿지 않도록 하십시오.</li>
