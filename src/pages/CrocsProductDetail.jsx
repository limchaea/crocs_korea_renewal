                        ...
                        <div className={`tab-content ${openDesc ? 'active' : ''}`}>
                            <div className="content-inner">
                                ...
                                <div className="desc-section">
                                    ...
                                    <ul className="desc-list">
                                        <li>
                                            궁극의 편안함과 스타일을 원한다면 새로운 클래식
                                            언퍼게터블 클로그의 인조 스웨이드 버전을 만나보세요.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            비건 인조 스웨이드 어퍼에 슬리퍼의 편안함을 제공하는
                                            인조 퍼 라이너, 칼라 및 백스트랩을 더한 것이 특징입니다.
                                        </li>
                                        <li>
                                            Croslite™ 아웃솔의 다용도성 덕분에 어디에서든 하루를
                                            함께할 수 있습니다.
                                        </li>
                                        <li>
                                            발을 감싸주는 부드러움을 선사하는 풋베드가 편안함을
                                            더해주며, 인조 퍼 백스트랩에는 지비츠™ 구멍이 있어
                                            개성을 표현할 수 있습니다.
                                        </li>
                                        <li>
                                ...
                                <div className="desc-section">
                                    ...
                                    <ul className="desc-list">
                                        ...
                                        <li>
                                            슬리퍼의 편안함을 제공하는 인조 퍼 라이너, 칼라 및
                                            백스트랩
                                        </li>
                                        <li>편안함을 더해주는 풋베드의 발을 감싸주는 부드러움</li>
                                        <li>
                                            피보팅 인조 퍼 백스트랩과 개성을 표현할 수 있는 지비츠™
                                            구멍
                                        </li>
                                        <li>
                                            아웃도어용으로 어울리는 Croslite™ 아웃솔이 선사하는
                                            다용도성
                                        </li>
                        ...
                        <div className={`tab-content ${openNotes ? 'active' : ''}`}>
                            <div className="content-inner">
                                ...
                                <div className="desc-section">
                                    ...
                                    <ul className="desc-list">
                                        <li>
                                            에스컬레이터나 무빙워크에서 사고방지를 위한 안내 안전선
                                            안에 위치하시고, 접촉면 어디에도 닿지 않도록 하십시오.
                                            아이들의 손을 잡고 늘 살펴보세요.
                                        </li>
                                        ...
                                        <li>
                                            36개월미만 어린이는 부자재 장식을 삼킬 위험이 있으니
                                            주의가 필요합니다.
                                        </li>
                                    </ul>
                                    ...
                                    <ul className="desc-list">
                                        ...
                                        <li>
                                            가죽, 스웨이드, 천은 물기 및 마찰에 의해 변형, 변색,
                                            물빠짐 현상이 나타날 수 있으며, 의복에 이염되는 경우가
                                            있으니 주의하십시오.
                                        </li>
                                        <li>
                                            미끄럼 방지 기능은 오랜기간 착화시 마모로 인해 기능이
                                            저하될 수 있습니다.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="desc-section">
                                    ...
                                    <p className="desc-text">
                                        저희 제품의 결함으로 확인된 제품에 대해서는 공정거래 위원회
                                        고시 소비자 분쟁 해결 기준에 의거 다음과 같이 교환 또는 보상
                                        받을 수 있습니다.
                                    </p>
                                    ...
                                    <ul className="desc-list">
                                        <li>
                                            ...
                                            제품을 관리해주시고, 소비자 부주의로 인한 품질 이상
                                            변형에 대해서는 책임을 지지 않습니다.
                                        </li>
                                        <li>
                                            소비자 과실 및 부주의로 인한 하자/ 착화로 인한 마모 및
                                            파손/ 잘못된 세탁 및 품질보증기간 경과 / 잘못된 착화로
                                            인한 변형 및 품질이상.
                                        </li>
                                    </ul>
